...
export default function Final() {
  ...
  return (
    <div className="finalbg">
      <section className="card stack final">
        ...
        <blockquote>
          Dies ist eine Empfehlung basierend auf deinen Entscheidungen und
          Werten – du kannst jederzeit neu starten und andere Wege ausprobieren.
        </blockquote>
        <div className="row">
          <a href="/character">
        ...
        <small className="help">
          Hinweis: Ein Neustart ändert oft die Ereignisreihenfolge und
          Ergebnisse.
        </small>
      </section>
    </div>
